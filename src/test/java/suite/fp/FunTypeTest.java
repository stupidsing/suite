...
public class FunTypeTest {
	...
	public void testFix() {
		...
		// getType("""
		// data (Fix :f) over :f as (Fix (:f, Fix :f)) ~
		// (:t => Fix Optional :t) of (Fix Value Fix None)
		// """);
	}
	...
	public void testStandard() {
		checkType("use STANDARD ~ ends-with", "[T] -> _", "[T] -> [T] -> boolean");
		checkType("use STANDARD ~ join", "T -> _", "T -> [[T]] -> [T]");
		checkType("use STANDARD ~ merge", "([T] -> _) -> _", "([T] -> [T] -> [T]) -> [T] -> [T]");
	}
