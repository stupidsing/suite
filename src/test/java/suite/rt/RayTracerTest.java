...
public class RayTracerTest {
	...
	public void test() throws IOException {
		...
		RayTraceObject sphere1 = Sphere.c(v(-1f, -1f, 3f), 1f, reflective(cr, 0.4f));
		RayTraceObject sphere2 = Sphere.c(v(0f, 0f, 5f), 1f, reflective(cg, 0.4f));
		RayTraceObject sphere3 = Sphere.c(v(-1f, 1f, 7f), 1f, reflective(cb, 0.4f));
		...
		Scene scene = new Scene(Arrays.asList(sphere0, sphere1, sphere2, sphere3, plane, triangle));
	...
	private Material reflective(Vector color, float index) {
		...
		final Vector reflectionIndex = v(reflectionIndex1, reflectionIndex1, reflectionIndex1);
