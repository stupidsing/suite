...
asi0:.s:.a .i .e :- asis:.s:.a .i .e, ! #
asi0:_s:.a .i .e :- asis:8:.a .i .e, ! #
asi0:16:.a .i (+x66, .e1)/.ex :- asis:32:.a .i .e1/.ex, ! #
asi0:32:.a .i (+x66, .e1)/.ex :- asis:16:.a .i .e1/.ex, ! #

asis:_s:_a () .e/.e #
asis:_s:_a (AAA ()) (+x37, .e)/.e #
asis:.s:_a (ADC (.op0, .op1)) .e :- asi-2op:.s .op0 .op1 +x10 +x80 2 .e #
asis:.s:_a (ADD (.op0, .op1)) .e :- asi-2op:.s .op0 .op1 +x00 +x80 0 .e #
asis:_s:.a (ADVANCE .a) .e/.e #
asis:.s:.a0 (ADVANCE .a1) (0, .e1)/.ex :- .a0 < .a1, let .a (.a0 + 1), asis:.s:.a (ADVANCE .a1) .e1/.ex #
asis:.s:_a (AND (.op0, .op1)) .e :- asi-2op:.s .op0 .op1 +x20 +x80 4 .e #
...
asis:.s:_a (CMP (.op0, .op1)) .e :- asi-2op:.s .op0 .op1 +x38 +x80 07 .e #
...
asis:.s:_a (DEC .op) .e :- asi-1op:.s .op +x48 +xFE 1 .e #
asis:.s:_a (DIV .rm) .e :- asi-rm:.s +xF6 .rm 6 .e #
asis:_s:_a (DS "") .e/.e #
asis:_s:_a (DS .s) (.b, .e1)/.ex :- .s != "", substring .s 0 1 .h, substring .s 1 0 .t, char.ascii .h .b, asis:_:_ (DS .t) .e1/.ex #
asis:_s:_a (HLT ()) (+xF4, .e)/.e #
asis:.s:_a (IDIV .rm) .e :- asi-rm:.s +xF6 .rm 7 .e #
asis:.s:_a (IMUL .rm) .e :- asi-rm:.s +xF6 .rm 5 .e #
...
asis:.s:_a (INC .op) .e :- asi-1op:.s .op +x40 +xFE 0 .e #
...
asis:_s:_a (JMP .rm) (+xFF, .e1)/.ex :- as-mod-num-rm:32 .rm 4 .e1/.ex #
...
asis:.s:_a (MOV (.rm, .imm)) .e :- asi-rm-imm:.s +xC6 .rm 0 .imm .e #
asis:.s:_a (MOV (.rm0, .rm1)) .e :- asi-rm-reg2:.s +x88 .rm0 .rm1 .e #
...
asis:.s:_a (MOVSX (.reg, .rm)) .e :- asi-reg-rm-extended:.s .reg .rm +xBE .e #
asis:.s:_a (MOVZX (.reg, .rm)) .e :- asi-reg-rm-extended:.s .reg .rm +xB6 .e #
asis:.s:_a (MUL .rm) .e :- asi-rm:.s +xF6 .rm 4 .e #
asis:_s:_a (NOP ()) (+x90, .e)/.e #
asis:_s:_a (OOP ()) (+x66, .e)/.e #
asis:.s:_a (OR (.op0, .op1)) .e :- asi-2op:.s .op0 .op1 +x08 +x80 1 .e #
asis:.s:_a (OUT (.port, .val)) .e :- asi-in-out:.s .val .port +xE6 .e #
asis:.s:_a (POP .op) .e :- asi-1op:.s .op +x58 +x8E 0 .e, .s != 8 #
...
asis:.s:_a (PUSH .op) .e :- asi-1op:.s .op +x50 +xFE 6 .e, .s != 8 #
...
asis:.s:_a (SAL (.rm, .op)) .e :- asi-shift:.s .rm .op +xD0 +xC0 4 .e #
asis:.s:_a (SAR (.rm, .op)) .e :- asi-shift:.s .rm .op +xD0 +xC0 7 .e #
asis:.s:_a (SBB (.op0, .op1)) .e :- asi-2op:.s .op0 .op1 +x18 +x80 3 .e #
...
asis:.s:_a (SHL (.rm, .op)) .e :- asi-shift:.s .rm .op +xD0 +xC0 4 .e #
asis:.s:_a (SHR (.rm, .op)) .e :- asi-shift:.s .rm .op +xD0 +xC0 5 .e #
asis:_s:_a (STI ()) (+xFB, .e)/.e #
asis:.s:_a (STOSB ()) (+xAA, .e)/.e :- .s = 8 #
asis:.s:_a (STOSD ()) (+xAB, .e)/.e :- .s = 32 #
asis:.s:_a (STOSW ()) (+xAB, .e)/.e :- .s = 16 #
asis:.s:_a (SUB (.op0, .op1)) .e :- asi-2op:.s .op0 .op1 +x28 +x80 5 .e #
...
asis:.s:_a (TEST (.rm, .imm)) .e :- asi-rm-imm:.s +xF6 .rm 0 .imm .e #
asis:.s:_a (TEST (.rm, .reg)) .e :- asi-rm-reg:.s +x84 .rm .reg .e #
asis:_s:_a (WRMSR ()) (+x0F, +x30, .e)/.e #
asis:.s:_a (XCHG (.acc, .reg)) (.b, .e)/.e :- as-reg:.s .acc 0, as-reg:.s .reg .r, let .b (+x90 + .r) #
asis:.s:_a (XCHG (.rm, .reg)) .e :- asi-rm-reg:.s +x86 .rm .reg .e #
asis:.s:_a (XOR (.op0, .op1)) .e :- asi-2op:.s .op0 .op1 +x30 +x80 6 .e #
...
asi-jump8 .a .target .e
	...
	, if (as-imm:8 .rel) (as-emit:8 .rel .e) (throw "Jumping too far")
#
...
asi-shift:.size .rm .op .b0 _ .n .e
	:- asi-rm:.size .b1 .rm .n .e
...
asi-1op:.size .reg .b _ _ .e :- asi-reg:.size .b .reg .e, .size != 8 #
asi-1op:.size .rm _ .b .n .e :- asi-rm:.size .b .rm .n .e #

-- Common two-operand instructions, like ADD, OR, XOR
asi-2op:.size .acc .imm .b0 _ _ .e
	:- asi-acc-imm:.size .b1 .acc .imm .e
	, .b1 = .b0 + 4
#
asi-2op:.size .rm0 .rm1 .b _ _ .e
	:- asi-rm-reg2:.size .b .rm0 .rm1 .e
#
asi-2op:.size .rm .imm8 _ .b0 .n (.b1, .e1)/.ex
	:- asi-rm-imm8:.size .rm .imm8 .n .e1/.ex
	, .b1 = .b0 + 3
#
asi-2op:.size .rm .imm _ .b .n .e
	:- asi-rm-imm:.size .b .rm .n .imm .e
#
...
asi-rm-reg2:.size .b .rm .reg .e
	:- asi-rm-reg:.size .b .rm .reg .e
#
asi-rm-reg2:.size .b0 .reg .rm .e
	:- asi-rm-reg:.size .b1 .rm .reg .e
	, .b1 = .b0 + 2
#
...
as-rm-regwd:.size .rm .reg .e
	:- as-reg:.size .reg .r
	, as-mod-num-rm:.size .rm .r .e
#
...
as-mod-rm:.size .reg (3 (.rexr .r)) () (0 0)
	:- as-rex-reg:.size .reg .rexr .r
#
as-mod-rm:_ (`.disp`) (0 (0 5)) () (32 .disp)
	:- not bound .disp; is.int .disp
#
as-mod-rm:_ .op (1 (.rexr 5)) () (8 0)
	:- (.op = `.reg`; .op = `.reg + 0`)
	, as-rex-reg:_ .reg .rexr 5
	, !
#
as-mod-rm:_ (`.reg + .disp`) (.mod (.rexr .r)) () (.ds .disp)
	:- as-rex-reg:32 .reg .rexr .r
	, as-disp-mod:.ds .disp .mod
	, not (.r = 4; .mod = 0, .r = 5; .r = 12; .mod = 0, .r = 13)
#
as-mod-rm:_ (`.indexReg * .scale + .baseReg + .disp`) (.mod 4) (.s (.rexir .ir) (.rexbr .br)) (.ds .disp)
	:- as-sib-scale .scale .s
	, as-rex-reg:32 .indexReg .rexir .ir
	, as-rex-reg:32 .baseReg .rexbr .br
	, as-disp-mod:.ds .disp .mod
#
as-mod-rm:.size (.prefix `.ptr`) (.mod .rm) .sib .dsd
	:- as-ptr-size .prefix .size
	, as-mod-rm:_ `.ptr` (.mod .rm) .sib .dsd
#
as-mod-rm:_ (`.reg`) (.mod .rm) .sib .dsd
	:- as-rex-reg:32 .reg _ _
	, as-mod-rm:_ (`.reg + 0`) (.mod .rm) .sib .dsd
#
as-mod-rm:_ (`.indexReg * .scale + .baseReg`) (.mod .rm) .sib .dsd
	:- as-mod-rm:_ (`.indexReg * .scale + .baseReg + 0`) (.mod .rm) .sib .dsd
#
...
as-rex-reg:8 DL 0 2 #
as-rex-reg:8 BL 0 3 #
as-rex-reg:8 AH 0 4 :- not as-mode-amd64 #
as-rex-reg:8 CH 0 5 :- not as-mode-amd64 #
as-rex-reg:8 DH 0 6 :- not as-mode-amd64 #
as-rex-reg:8 BH 0 7 :- not as-mode-amd64 #
as-rex-reg:8 R4B 0 4 :- as-mode-amd64 #
as-rex-reg:8 R5B 0 5 :- as-mode-amd64 #
as-rex-reg:8 R6B 0 6 :- as-mode-amd64 #
as-rex-reg:8 R7B 0 7 :- as-mode-amd64 #
as-rex-reg:8 R8B 1 0 :- as-mode-amd64 #
as-rex-reg:8 R9B 1 1 :- as-mode-amd64 #
as-rex-reg:8 R10B 1 2 :- as-mode-amd64 #
as-rex-reg:8 R11B 1 3 :- as-mode-amd64 #
as-rex-reg:8 R12B 1 4 :- as-mode-amd64 #
as-rex-reg:8 R13B 1 5 :- as-mode-amd64 #
as-rex-reg:8 R14B 1 6 :- as-mode-amd64 #
as-rex-reg:8 R15B 1 7 :- as-mode-amd64 #
as-rex-reg:16 AX 0 0 #
as-rex-reg:16 CX 0 1 #
as-rex-reg:16 DX 0 2 #
as-rex-reg:16 BX 0 3 #
as-rex-reg:16 SP 0 4 #
as-rex-reg:16 BP 0 5 #
as-rex-reg:16 SI 0 6 #
as-rex-reg:16 DI 0 7 #
as-rex-reg:16 R8W 1 0 :- as-mode-amd64 #
as-rex-reg:16 R9W 1 1 :- as-mode-amd64 #
as-rex-reg:16 R10W 1 2 :- as-mode-amd64 #
as-rex-reg:16 R11W 1 3 :- as-mode-amd64 #
as-rex-reg:16 R12W 1 4 :- as-mode-amd64 #
as-rex-reg:16 R13W 1 5 :- as-mode-amd64 #
as-rex-reg:16 R14W 1 6 :- as-mode-amd64 #
as-rex-reg:16 R15W 1 7 :- as-mode-amd64 #
as-rex-reg:32 EAX 0 0 #
as-rex-reg:32 ECX 0 1 #
as-rex-reg:32 EDX 0 2 #
as-rex-reg:32 EBX 0 3 #
as-rex-reg:32 ESP 0 4 #
as-rex-reg:32 EBP 0 5 #
as-rex-reg:32 ESI 0 6 #
as-rex-reg:32 EDI 0 7 #
as-rex-reg:32 R8D 1 0 :- as-mode-amd64 #
as-rex-reg:32 R9D 1 1 :- as-mode-amd64 #
as-rex-reg:32 R10D 1 2 :- as-mode-amd64 #
as-rex-reg:32 R11D 1 3 :- as-mode-amd64 #
as-rex-reg:32 R12D 1 4 :- as-mode-amd64 #
as-rex-reg:32 R13D 1 5 :- as-mode-amd64 #
as-rex-reg:32 R14D 1 6 :- as-mode-amd64 #
as-rex-reg:32 R15D 1 7 :- as-mode-amd64 #
as-rex-reg:64 RAX 0 0 #
as-rex-reg:64 RCX 0 1 #
as-rex-reg:64 RDX 0 2 #
as-rex-reg:64 RBX 0 3 #
as-rex-reg:64 RSP 0 4 #
as-rex-reg:64 RBP 0 5 #
as-rex-reg:64 RSI 0 6 #
as-rex-reg:64 RDI 0 7 #
as-rex-reg:64 R8 1 0 :- as-mode-amd64 #
as-rex-reg:64 R9 1 1 :- as-mode-amd64 #
as-rex-reg:64 R10 1 2 :- as-mode-amd64 #
as-rex-reg:64 R11 1 3 :- as-mode-amd64 #
as-rex-reg:64 R12 1 4 :- as-mode-amd64 #
as-rex-reg:64 R13 1 5 :- as-mode-amd64 #
as-rex-reg:64 R14 1 6 :- as-mode-amd64 #
as-rex-reg:64 R15 1 7 :- as-mode-amd64 #
