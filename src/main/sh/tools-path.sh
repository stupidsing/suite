...
GH_HOME=$(cchs "echo https://github.com/cli/cli/releases/download/v1.8.1/gh_1.8.1_linux_amd64.tar.gz" @curl @tar-zxf @dir)
...
NODE_HOME=$(cchs "echo https://nodejs.org/dist/v14.15.4/node-v14.15.4-linux-x64.tar.xz" @curl @tar-xf @dir)
