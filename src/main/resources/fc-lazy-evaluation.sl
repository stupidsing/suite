...
fc-compile .do .env .c0/.cx/.d0/.dx/.reg
	:- fc-compile0 .do .env .c0/.c1/.d0/.dx/.closureReg
	, .c1 = (_ CALL-CLOSURE .reg .closureReg, .cx)
#

fc-compile0 (CAST _ .do) .env .cdr :- !, fc-compile0 .do .env .cdr #
fc-compile0 (AS _ _ .do) .env .cdr :- !, fc-compile0 .do .env .cdr #
fc-compile0 (DEF-VAR .var .value .do) .frame/.ve .c0/.cx/.d0/.dx/.reg
	:- !
	, .env1 = .frame/(.var/(%REG/.r1/.frame), .ve)
	, fc-compile0 .value .env1 .c0/.c1/.d0/.d1/.r1
	, fc-compile0 .do .env1 .c1/.cx/.d1/.dx/.reg
#
fc-compile0 (IF .if .then .else) .env .c0/.cx/.d0/.dx/.reg
	:- !
	, fc-compile .if .env .c0/.c1/.d0/.d1/.ifReg
	, .c1 = (_ IF-FALSE .label1 .ifReg, .c2)
	, fc-compile0 .then .env .c2/.c3/.d1/.d2/.thenReg
	, .c3 = (_ ASSIGN-FRAME-REG .reg 0 .thenReg
		, _ JUMP .label2
		, .label1 LABEL .label1
		, .c4
	)
	, fc-compile0 .else .env .c4/.c5/.d2/.dx/.elseReg
	, .c5 = (_ ASSIGN-FRAME-REG .reg 0 .elseReg
		, .label2 LABEL .label2
		, .cx
	)
#
fc-compile0 (VARIABLE .var) .frame/.ve .c0/.cx/.d/.d/.reg1
...
#
fc-compile0 (INVOKE .p (VARIABLE .var)) .env .c0/.cx/.d0/.dx/.reg
	:- member (head, tail,) .var -- Special list processing function
	, fc-define-default-fun 1 .var .call, !
	, fc-compile .p .env .c0/.c1/.d0/.dx/.paramReg
	, .c1 = (_ PUSH .paramReg, _ SYS .reg .call 1, .cx)
#
fc-compile0 .do .frame/.ve .c0/.cx/.d0/.dx/.closureReg
	:- .c0 = (_ ASSIGN-CLOSURE .closureReg .funcLabel, .cx)
	, let .frame1 (.frame + 1)
	, .d0 = (.funcLabel ENTER, .d1)
	, fc-compile-wrapped .do .frame1/.ve .d1/.d2/.d3/.dx/.returnReg
	, .d2 = (_ RETURN-VALUE .returnReg, _ LEAVE, .d3)
	, !
#

fc-compile-wrapped (FUN .var .do) .frame/.ve .c0/.cx/.d0/.dx/.reg
	:- !
	...
	, fc-compile0 .do .env1 .d2/.d3/.d4/.dx/.returnReg
	, .d3 = (_ RETURN-VALUE .returnReg, _ LEAVE, .d4)
#
fc-compile-wrapped (INVOKE .p (VARIABLE .var)) .env .c0/.cx/.d0/.dx/.reg
	:- member (is-tree,) .var -- Special list processing function
	, fc-define-default-fun 1 .var .call, !
	, fc-compile .p .env .c0/.c1/.d0/.dx/.paramReg
	, .c1 = (_ PUSH .paramReg, _ SYS .reg .call 1, .cx)
#
fc-compile-wrapped (INVOKE .p0 (INVOKE .p1 (VARIABLE .var))) .env .c0/.cx/.d0/.dx/.reg
	:- member (cons,) .var -- Special list processing function
	, fc-define-default-fun 2 .var .call, !
	, fc-compile0 .p0 .env .c0/.c1/.d0/.d1/.param0Reg
	, fc-compile0 .p1 .env .c1/.c2/.d1/.dx/.param1Reg
	, .c2 = (_ PUSH .param0Reg, _ PUSH .param1Reg, _ SYS .reg .call 2, .cx)
#
fc-compile-wrapped (INVOKE .parameter .callee) .env .c0/.cx/.d0/.dx/.reg
	:- !
	, fc-compile .callee .env .c0/.c1/.d0/.d1/.r1
	, fc-compile0 .parameter .env .c1/.c2/.d1/.dx/.r2
	, .c2 = (_ PUSH .r2
...
#
fc-compile-wrapped .do .env .cdr
	:- fc-default-fun .do .env .cdr, !
#
fc-compile-wrapped (TUPLE .name .es) .env .cdr
	:- !, fc-compile-tuple .name .es .env .cdr
#
fc-compile-wrapped (TREE .oper .left .right) .env .c0/.cx/.d0/.dx/.reg
	:- !
...
fc-default-fun .call .env .result
	:- fc-default-fun0 .call .env .result 0
#

fc-default-fun0 (INVOKE .p .pred) .env .c0/.cx/.d0/.dx/.reg .n
	:- !, let .n1 (.n + 1)
	, fc-compile .p .env .c0/.c1/.d0/.d1/.r1
	, .c1 = (_ PUSH .r1, .c2)
	, fc-default-fun0 .pred .env .c2/.cx/.d1/.dx/.reg .n1
#
