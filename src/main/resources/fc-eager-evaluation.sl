...
fc-compile EAGER (CAST _ .do) .env .cdr :- !, fc-compile EAGER .do .env .cdr #
fc-compile EAGER (AS _ _ .do) .env .cdr :- !, fc-compile EAGER .do .env .cdr #
...
#
fc-compile EAGER (TUPLE .name (.e, .es)) .env .c0/.cx/.d0/.dx/.reg
	:- !, fc-compile EAGER .e .env .c0/.c1/.d0/.d1/.headReg
	, fc-compile EAGER (TUPLE .name .es) .env .c1/.c2/.d1/.dx/.tailReg
	, .c2 = (_ PUSH .headReg
		, _ PUSH .tailReg
		, _ SYS .reg CONS 2
		, .cx
