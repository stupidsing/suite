...
fc-lazyify-default-fun .n .paramWraps .returnWrap (VAR .var) (VAR .var)
	:- member (
		...
		+getintrn/1/VALUE:/VALUE,
		+callintrn0/1/VALUE:/VALUE,
		+callintrn1/2/VALUE:VALUE:/VALUE,
		+callintrn2/3/VALUE:VALUE:VALUE:/VALUE,
		+callintrn3/4/VALUE:VALUE:VALUE:VALUE:/VALUE,
