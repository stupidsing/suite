...
default-fun-type _ijavaclass (FUN-OF (ATOM-OF _) _) #
default-fun-type _ijavaobject0 (FUN-OF _ _) #
default-fun-type _ijavaobject1 (FUN-OF _ (FUN-OF _ _)) #
default-fun-type _ijavaobject2 (FUN-OF _ (FUN-OF _ (FUN-OF _ _))) #
