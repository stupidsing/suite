...
#
infer-type-rule (USING _ .lib .do) .env .tr/.tr .type
	:- !
	, memoize .precompiled (fc-load-precompiled-library .lib .precompiled) ((.pred # _ # _ # _ #),)
	, generalize .pred (infer-type-rule-using-lib .lib .do .env .tr1/() .type :- .tail)
	, once .tail
...
default-fun-type _ijavacls (FUN-OF (ATOM-OF 	_) (DATA-OF Invocable)) #
default-fun-type _ijavaobj0 (FUN-OF (DATA-OF Invocable) _) #
default-fun-type _ijavaobj1 (FUN-OF (DATA-OF Invocable) (FUN-OF _ _)) #
default-fun-type _ijavaobj2 (FUN-OF (DATA-OF Invocable) (FUN-OF _ (FUN-OF _ _))) #
