...
import suite.funp.p1.P12ReduceTailCall;
...
public class Funp_ extends FunpCfg {
	...
	public class Main {
		...
		public Pair<List<Instruction>, Bytes> compile(int offset, String fp) {
			...
			var p11 = new P11Inline(f);
			var p12 = new P12ReduceTailCall(f);
			...
			var n1 = p10.check(n0);
			var n2 = p12.reduce(n1);
			var n3 = p11.inline(n2, isOptimize ? 3 : 0, 1, 1, 1, 1, 1);
			var n4 = p2.infer(n3);
