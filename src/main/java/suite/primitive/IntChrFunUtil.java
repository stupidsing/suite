...
public class IntChrFunUtil {
	...
	public static <V> IntChrSource filterKey(IntPredicate fun0, IntChrSource source2) {
	...
	public static IntChrSource filterValue(ChrPredicate fun0, IntChrSource source2) {
