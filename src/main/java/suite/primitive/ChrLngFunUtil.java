...
public class ChrLngFunUtil {
	...
	public static <V> ChrLngSource filterKey(ChrPredicate fun0, ChrLngSource source2) {
	...
	public static ChrLngSource filterValue(LngPredicate fun0, ChrLngSource source2) {
