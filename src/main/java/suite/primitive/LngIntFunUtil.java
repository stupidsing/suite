...
public class LngIntFunUtil {
	...
	public static <V> LngIntSource filterKey(LngPredicate fun0, LngIntSource source2) {
	...
	public static LngIntSource filterValue(IntPredicate fun0, LngIntSource source2) {
