...
public class DblLngFunUtil {
	...
	public static <V> DblLngSource filterKey(DblPredicate fun0, DblLngSource source2) {
	...
	public static DblLngSource filterValue(LngPredicate fun0, DblLngSource source2) {
	...
	public static <T> Source<T> mapNonNull(DblLng_Obj<T> fun0, DblLngSource source) {
		DblLng_Obj<T> fun1 = fun0.rethrow();
		return new Source<T>() {
			public T source() {
				DblLngPair pair = DblLngPair.of((double) 0, (long) 0);
