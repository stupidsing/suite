...
public class LngDblFunUtil {
	...
	public static <V> LngDblSource filterKey(LngPredicate_ fun0, LngDblSource source2) {
	...
	public static LngDblSource filterValue(DblPredicate_ fun0, LngDblSource source2) {
	...
	public static <T> Source<T> mapNonNull(LngDbl_Obj<T> fun, LngDblSource source) {
		return new Source<T>() {
			public T source() {
				LngDblPair pair = LngDblPair.of((long) 0, (double) 0);
				T t1 = null;
