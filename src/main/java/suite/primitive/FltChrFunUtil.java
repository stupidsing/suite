...
public class FltChrFunUtil {
	...
	public static <V> FltChrSource filterKey(FltPredicate fun0, FltChrSource source2) {
	...
	public static FltChrSource filterValue(ChrPredicate fun0, FltChrSource source2) {
