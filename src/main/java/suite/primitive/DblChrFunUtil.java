...
public class DblChrFunUtil {
	...
	public static <V> DblChrSource filterKey(DblPredicate fun0, DblChrSource source2) {
	...
	public static DblChrSource filterValue(ChrPredicate fun0, DblChrSource source2) {
	...
	public static <T> Source<T> mapNonNull(DblChr_Obj<T> fun0, DblChrSource source) {
		DblChr_Obj<T> fun1 = fun0.rethrow();
		return new Source<T>() {
			public T source() {
				DblChrPair pair = DblChrPair.of((double) 0, (char) 0);
