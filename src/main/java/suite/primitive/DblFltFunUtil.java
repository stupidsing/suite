...
public class DblFltFunUtil {
	...
	public static <V> DblFltSource filterKey(DblPredicate fun0, DblFltSource source2) {
	...
	public static DblFltSource filterValue(FltPredicate fun0, DblFltSource source2) {
