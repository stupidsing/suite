...
public class FltLngFunUtil {
	...
	public static <V> FltLngSource filterKey(FltPredicate fun0, FltLngSource source2) {
	...
	public static FltLngSource filterValue(LngPredicate fun0, FltLngSource source2) {
