...
public class LngFltFunUtil {
	...
	public static <V> LngFltSource filterKey(LngPredicate fun0, LngFltSource source2) {
	...
	public static LngFltSource filterValue(FltPredicate fun0, LngFltSource source2) {
