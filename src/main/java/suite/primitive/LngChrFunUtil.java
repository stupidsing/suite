...
public class LngChrFunUtil {
	...
	public static <V> LngChrSource filterKey(LngPredicate_ fun0, LngChrSource source2) {
	...
	public static LngChrSource filterValue(ChrPredicate_ fun0, LngChrSource source2) {
	...
	public static <T> Source<T> mapNonNull(LngChr_Obj<T> fun, LngChrSource source) {
		return new Source<T>() {
			public T source() {
				LngChrPair pair = LngChrPair.of((long) 0, (char) 0);
				T t1 = null;
