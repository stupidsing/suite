...
public class IntDblFunUtil {
	...
	public static <V> IntDblSource filterKey(IntPredicate_ fun0, IntDblSource source2) {
	...
	public static IntDblSource filterValue(DblPredicate_ fun0, IntDblSource source2) {
	...
	public static <T> Source<T> mapNonNull(IntDbl_Obj<T> fun, IntDblSource source) {
		return new Source<T>() {
			public T source() {
				IntDblPair pair = IntDblPair.of((int) 0, (double) 0);
				T t1 = null;
