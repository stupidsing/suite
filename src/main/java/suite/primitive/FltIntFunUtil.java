...
public class FltIntFunUtil {
	...
	public static <V> FltIntSource filterKey(FltPredicate fun0, FltIntSource source2) {
	...
	public static FltIntSource filterValue(IntPredicate fun0, FltIntSource source2) {
