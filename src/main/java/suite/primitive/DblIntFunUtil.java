...
public class DblIntFunUtil {
	...
	public static <V> DblIntSource filterKey(DblPredicate_ fun0, DblIntSource source2) {
	...
	public static DblIntSource filterValue(IntPredicate_ fun0, DblIntSource source2) {
	...
	public static <T> Source<T> mapNonNull(DblInt_Obj<T> fun, DblIntSource source) {
		return new Source<T>() {
			public T source() {
				DblIntPair pair = DblIntPair.of((double) 0, (int) 0);
				T t1 = null;
