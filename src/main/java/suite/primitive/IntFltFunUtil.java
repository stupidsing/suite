...
public class IntFltFunUtil {
	...
	public static <V> IntFltSource filterKey(IntPredicate fun0, IntFltSource source2) {
	...
	public static IntFltSource filterValue(FltPredicate fun0, IntFltSource source2) {
	...
	public static <T> Source<T> mapNonNull(IntFlt_Obj<T> fun0, IntFltSource source) {
		IntFlt_Obj<T> fun1 = fun0.rethrow();
		return new Source<T>() {
			public T source() {
				IntFltPair pair = IntFltPair.of((int) 0, (float) 0);
