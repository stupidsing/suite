...
public class EmaAssetAllocator implements AssetAllocator {
	...
	public static AssetAllocator of(Configuration cfg, Sink<String> log) {
		return EmaAssetAllocator.of_(cfg, log);
	}

	public static EmaAssetAllocator of_(Configuration cfg, Sink<String> log) {
		return new EmaAssetAllocator(cfg, log);
	}

	private EmaAssetAllocator(Configuration cfg, Sink<String> log) {
		this.cfg = cfg;
		this.log = log;
	}
